...
const Home = () => {
  ...
  return (
    <>
      ...
      <section id="hero" className="container mx-auto grid md:grid-cols-2 min-h-screen items-center content-center">
      ...
      <section id="personal" className="container grid grid-cols-2" ref={personalRef}>
      ...
      <section id="contact" className="container grid md:grid-cols-3">
