...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section id="hero" className="container hero max-w-none flex flex-col sm:flex-row justify-center flex-wrap px-8">
      ...
      <section id="personal" className="container max-w-none flex flex-col sm:flex-row justify-center flex-wrap" ref={personalRef}>
      ...
      <section id="portfolio" className="container max-w-none portfolio-content flex flex-col sm:flex-row justify-center flex-wrap">
      ...
      <section id="contact" className="container max-w-none flex flex-col sm:flex-row justify-center flex-wrap">
