...
const CV = () => {
  ...
  const experiences = [
    { text: 'Frontend Developer at <a class="text-darkPurple dark:text-orange cursor-pointer" href="https://reference.be">The Reference</a>, Ghent', date: 'October 2018 - now' },
    { text: 'Full Stack Developer at <a class="text-darkPurple dark:text-orange cursor-pointer" href="https://happsdevelopment.com">Happs Development</a>, Ghent', date: 'September 2017 - October 2018' },
    { text: 'Internship as Swift Developer at <a class="text-darkPurple dark:text-orange cursor-pointer" href="https://getrialto.com">Rialto</a>, Ghent', date: 'February 2017 - June 2017' },
    { text: 'Bachelor Applied Computer Sciences at <a class="text-darkPurple dark:text-orange cursor-pointer" href="https://hogent.be">Hogeschool Gent</a>', date: 'September 2014 - June 2017' },
    { text: 'Support Engineer at <a class="text-darkPurple dark:text-orange cursor-pointer" href="https://telenet.be">Telenet</a>, Lochristi', date: 'May 2012 - August 2014' }
  ];
  useEffect(() => {
    AOS.init({
      duration: 1000
  ...
  return (
    <>
      ...
      <section id="cv" className="dark:bg-lightgrey dark:text-whitedarktheme">
        <div className="container py-6 mx-auto grid grid-cols-1 sm:grid-cols-3 sm:gap-16">
          ...
          <div className="col-span-1 mx-6 mt-6 sm:mt-0 sm:mx-0 sm:col-span-2 flex flex-col justify-center">
            ...
            <div>
              <p>Hi, I'm Thomas. I'm {age} years old, living in Ghent. I'm a professional Frontend Developer, currently working at <a className="text-darkPurple dark:text-orange underline" href="https://www.the-reference.be">The Reference</a>.</p>
