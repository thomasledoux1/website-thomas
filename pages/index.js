...
const Home = () => {
  ...
  return (
    <>
      ...
      <section id="hero" className="min-h-screen-without-nav min-h-screen-without-nav-ios items-center content-center flex pb-16 dark:bg-lightgrey dark:text-whitedarktheme">
      ...
      <section id="contact" className="bg-purple dark:bg-darkgrey dark:text-whitedarktheme">
        <div className="container grid md:grid-cols-3 gap-6 min-h-screen-without-nav min-h-screen-without-nav-ios content-center align-items">
