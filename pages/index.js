...
const Home = () => {
  ...
  return (
    <>
      ...
      <section id="hero" className="min-h-screen-without-nav items-center content-center flex pb-16 dark:bg-lightgrey dark:text-whitedarktheme">
      ...
      <section id="personal" className="bg-purple dark:bg-darkgrey py-6" ref={personalRef}>
        <div className="container mx-auto grid md:grid-cols-2 min-h-screen items-center content-center">
          ...
          <div data-aos="fade-left" className="bg-white dark:bg-lightgrey dark:text-whitedarktheme p-6 mt-6 sm:mt-0 mx-6 sm:mx-0">
            <div>
      ...
      <section id="portfolio" className="dark:bg-lightgrey dark:text-whitedarktheme">
        <div className="container mx-auto min-h-screen items-center content-center py-6">
      ...
      <section id="contact" className="bg-purple dark:bg-darkgrey dark:text-whitedarktheme">
        <div className="container grid md:grid-cols-3 gap-6 min-h-screen-without-nav content-center align-items">
          ...
          <div data-aos="fade-up-left" className="p-6 flex justify-center items-center flex-col">
